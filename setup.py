#!/usr/bin/env python3
"""
setup.py -- one-command bootstrap for the Retirement Planning Toolkit.
...
def main():
    ap = argparse.ArgumentParser(description="Bootstrap the Retirement Planning Toolkit")
    ...
    print("\n" + "=" * 66)
    print("  Retirement Planning Toolkit -- setup")
    print("=" * 66 + "\n")
